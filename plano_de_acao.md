...
Iniciativas estruturadas que demandam ciclos contínuos de acompanhamento, avaliação clínica-pedagógica e fabricação iterativa:
*   **Projeto Codesign de Tecnologia Assistiva Personalizada:** Ciclo de desenvolvimento em parceria direta com fisioterapeutas municipais e Terapeutas Ocupacionais (TO). O aluno é acompanhado ao longo de 3 a 6 meses para desenhar, testar e adaptar órteses de posicionamento, adaptadores de talheres, pratos com ventosas personalizadas e suportes ergonômicos de cadeira de rodas. Cada versão física passa por um ciclo de uso na escola, feedback clínico e reimpressão em materiais variados (como TPU flexível).
...
*   **Workshops Itinerantes "Minuto Inclusivo":** A equipe do Espaço Inova realizará oficinas rápidas nas reuniões pedagógicas das escolas para expor e demonstrar o funcionamento prático de órteses e jogos táteis desenvolvidos no espaço.
